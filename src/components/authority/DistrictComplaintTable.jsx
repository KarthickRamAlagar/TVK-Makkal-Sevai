  ...
  return (
    <div className="w-full lg:px-4 xl:px-7">
      <div className="overflow-x-scroll md:overflow-x-auto px-2 md:px-0">
        <table className="w-full border-collapse text-base md:text-lg whitespace-nowrap min-w-full md:min-w-[700px]">
          <thead>
...
export default DistrictComplaintTable;
